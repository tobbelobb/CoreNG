...
// Serial2
static const Pin APINS_Serial2 = 111;
static const Pin APIN_Serial2_RXD = 26; // Same as APIN_USART_SSPI_MISO
static const Pin APIN_Serial2_TXD = 27; // Same as APIN_USART_SSPI_MOSI
